LectureLoot::Application.routes.draw do
  namespace :api do
    namespace :v1 do
      resources :schedules, except: [:new, :edit]
      resources :current_sessions, except: [:new, :edit]
      resources :wagers, except: [:new, :edit]
      resources :class_actions, except: [:new, :edit]
